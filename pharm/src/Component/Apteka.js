      ...
      <div>
        <div className={styles.HeaderMenu} style={{ width: "100%" }}>
          ...
          <Container>
            ...
            <Row>
              <Col lg={6}>
                <h1 className={styles.headertext} style={{ textAlign: "left" }}>
                  Eng sifatli xizmat va dorilar HEALTH dorixonalarida!
                </h1>
                <div className={styles.MenuTextButtons}>
                  ...
                  >
                    <p
                      className={styles.WhatchVideop1}
                      style={{
                        fontSize: "27px",
                        color: "white",
                        marginLeft: "10%",
                    ...
                    <p
                      className={styles.WhatchVideop2}
                      style={{
                        marginLeft: "10px",
                        color: "white",
                        fontSize: "18px",
                    ...
                    >
                      ...
                      <CardContent>
                        ...
                        >
                          ...
                          alias asperiores eius. Earum, natus!
                        </Typography>
                      </CardContent>
