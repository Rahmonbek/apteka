...
<a href="#2" className={style.aloqa3}><PhoneFilled className={style.icons} /><span style={{paddingLeft:'10px'}}>+998(94)-000-00-00</span></a>
<a href="#3" className={style.aloqa3}>< MailOutlined className={style.icons}  /><span style={{paddingLeft:'10px'}}>uzApteka@mail.ru</span></a>
</div>
...
<YoutubeOutlined className={style.icbog} style={{margin:'0px'}}/>
</div>
</div>
</div>
